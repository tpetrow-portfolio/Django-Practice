...
if LmctLigandsHybridizationTerm then
    ...
    Va1g_5d_L1_m = $Va1g(5d,L1)_m_value
    Vb1g_5d_L1_m = $Vb1g(5d,L1)_m_value
    Vb2g_5d_L1_m = $Vb2g(5d,L1)_m_value
    Veg_5d_L1_m = $Veg(5d,L1)_m_value
    ...
    H_m = H_m + Chop(
        ...
        + Ds_L1_m * Ds_L1
        + Dt_L1_m * Dt_L1
        + Va1g_5d_L1_m * Va1g_5d_L1
        + Vb1g_5d_L1_m * Vb1g_5d_L1
        + Vb2g_5d_L1_m * Vb2g_5d_L1
        + Veg_5d_L1_m * Veg_5d_L1)
...
if MlctLigandsHybridizationTerm then
    ...
    E_L2_m = (2 * Delta_5d_L2_m * NElectrons_5d + 12 * Delta_5d_L2_m + U_5d_5d_m * NElectrons_5d^2 - U_5d_5d_m * NElectrons_5d - 12 * U_5d_5d_m + 12 * U_2p_5d_m * NElectrons_5d + 12 * U_2p_5d_m) / (2 * (NElectrons_5d + 6))
    ...
    Va1g_5d_L2_m = $Va1g(5d,L2)_m_value
    Vb1g_5d_L2_m = $Vb1g(5d,L2)_m_value
    Vb2g_5d_L2_m = $Vb2g(5d,L2)_m_value
    Veg_5d_L2_m = $Veg(5d,L2)_m_value
    ...
    H_m = H_m + Chop(
        ...
        + Ds_L2_m * Ds_L2
        + Dt_L2_m * Dt_L2
        + Va1g_5d_L2_m * Va1g_5d_L2
        + Vb1g_5d_L2_m * Vb1g_5d_L2
        + Vb2g_5d_L2_m * Vb2g_5d_L2
        + Veg_5d_L2_m * Veg_5d_L2)
