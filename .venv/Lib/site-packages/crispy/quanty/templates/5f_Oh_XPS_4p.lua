...
if LmctLigandsHybridizationTerm then
    ...
    E_5f_f = (28 * Delta_5f_L1_f - U_5f_5f_f * NElectrons_5f^2 - 39 * U_5f_5f_f * NElectrons_5f - 228 * U_4p_5f_f) / (2 * (NElectrons_5f + 20))
    E_4p_f = (28 * Delta_5f_L1_f + U_5f_5f_f * NElectrons_5f^2 + U_5f_5f_f * NElectrons_5f - 2 * U_4p_5f_f * NElectrons_5f^2 - 30 * U_4p_5f_f * NElectrons_5f - 28 * U_4p_5f_f) / (2 * (NElectrons_5f + 20))
    E_L1_f = (-2 * Delta_5f_L1_f * NElectrons_5f - 12 * Delta_5f_L1_f + U_5f_5f_f * NElectrons_5f^2 + U_5f_5f_f * NElectrons_5f + 12 * U_4p_5f_f * NElectrons_5f + 12 * U_4p_5f_f) / (2 * (NElectrons_5f + 20))
...
for i = 1, NElectrons_4p / 2 do
    T_4p_5f[2*i - 1] = NewOperator("An", NFermions, IndexDn_4p[i])
    T_4p_5f[2*i]     = NewOperator("An", NFermions, IndexUp_4p[i])
end
...
if ValueInTable(Spectrum, SpectraToCalculate) then
    SpectrumIds = {}
    c = 1
    for i, Operator in ipairs(T_4p_5f) do
