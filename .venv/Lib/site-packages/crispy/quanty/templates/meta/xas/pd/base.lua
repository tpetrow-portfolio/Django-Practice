...
if AtomicTerm then
    ...
    G1_#i_#f = NewOperator("U", NFermions, IndexUp_#i, IndexDn_#i, IndexUp_#f, IndexDn_#f, {0, 0}, {1, 0})
    G3_#i_#f = NewOperator("U", NFermions, IndexUp_#i, IndexDn_#i, IndexUp_#f, IndexDn_#f, {0, 0}, {0, 1})
    ...
    F0_#i_#f_f = U_#i_#f_f + 1 / 15 * G1_#i_#f_f + 3 / 70 * G3_#i_#f_f
