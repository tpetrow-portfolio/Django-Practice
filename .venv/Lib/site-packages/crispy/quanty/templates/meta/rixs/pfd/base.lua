...
if AtomicTerm then
    F0_#m_#m = NewOperator("U", NFermions, IndexUp_#m, IndexDn_#m, {1, 0, 0, 0})
    F2_#m_#m = NewOperator("U", NFermions, IndexUp_#m, IndexDn_#m, {0, 1, 0, 0})
    F4_#m_#m = NewOperator("U", NFermions, IndexUp_#m, IndexDn_#m, {0, 0, 1, 0})
    F6_#m_#m = NewOperator("U", NFermions, IndexUp_#m, IndexDn_#m, {0, 0, 0, 1})
    ...
    G2_#i_#m = NewOperator("U", NFermions, IndexUp_#i, IndexDn_#i, IndexUp_#m, IndexDn_#m, {0, 0}, {1, 0})
    G4_#i_#m = NewOperator("U", NFermions, IndexUp_#i, IndexDn_#i, IndexUp_#m, IndexDn_#m, {0, 0}, {0, 1})
  
    F0_#f_#m = NewOperator("U", NFermions, IndexUp_#f, IndexDn_#f, IndexUp_#m, IndexDn_#m, {1, 0, 0}, {0, 0, 0});
    F2_#f_#m = NewOperator("U", NFermions, IndexUp_#f, IndexDn_#f, IndexUp_#m, IndexDn_#m, {0, 1, 0}, {0, 0, 0});
    F4_#f_#m = NewOperator("U", NFermions, IndexUp_#f, IndexDn_#f, IndexUp_#m, IndexDn_#m, {0, 0, 1}, {0, 0, 0});
    G1_#f_#m = NewOperator("U", NFermions, IndexUp_#f, IndexDn_#f, IndexUp_#m, IndexDn_#m, {0, 0, 0}, {1, 0, 0});
    G3_#f_#m = NewOperator("U", NFermions, IndexUp_#f, IndexDn_#f, IndexUp_#m, IndexDn_#m, {0, 0, 0}, {0, 1, 0});
    G5_#f_#m = NewOperator("U", NFermions, IndexUp_#f, IndexDn_#f, IndexUp_#m, IndexDn_#m, {0, 0, 0}, {0, 0, 1});

    U_#m_#m_i  = $U(#m,#m)_i_value
    F2_#m_#m_i = $F2(#m,#m)_i_value * $F2(#m,#m)_i_scaleFactor
    F4_#m_#m_i = $F4(#m,#m)_i_value * $F4(#m,#m)_i_scaleFactor
    F6_#m_#m_i = $F6(#m,#m)_i_value * $F6(#m,#m)_i_scaleFactor
    F0_#m_#m_i = U_#m_#m_i + 4 / 195 * F2_#m_#m_i + 2 / 143 * F4_#m_#m_i + 100 / 5577 * F6_#m_#m_i

    U_#m_#m_m  = $U(#m,#m)_m_value
    F2_#m_#m_m = $F2(#m,#m)_m_value * $F2(#m,#m)_m_scaleFactor
    F4_#m_#m_m = $F4(#m,#m)_m_value * $F4(#m,#m)_m_scaleFactor
    F6_#m_#m_m = $F6(#m,#m)_m_value * $F6(#m,#m)_m_scaleFactor
    F0_#m_#m_m = U_#m_#m_m + 4 / 195 * F2_#m_#m_m + 2 / 143 * F4_#m_#m_m + 100 / 5577 * F6_#m_#m_m
    U_#i_#m_m  = $U(#i,#m)_m_value
    F2_#i_#m_m = $F2(#i,#m)_m_value * $F2(#i,#m)_m_scaleFactor
    G2_#i_#m_m = $G2(#i,#m)_m_value * $G2(#i,#m)_m_scaleFactor
    G4_#i_#m_m = $G4(#i,#m)_m_value * $G4(#i,#m)_m_scaleFactor
    F0_#i_#m_m = U_#i_#m_m + 3 / 70 * G2_#i_#m_m + 2 / 63 * G4_#i_#m_m

    U_#m_#m_f  = $U(#m,#m)_f_value
    F2_#m_#m_f = $F2(#m,#m)_f_value * $F2(#m,#m)_f_scaleFactor
    F4_#m_#m_f = $F4(#m,#m)_f_value * $F4(#m,#m)_f_scaleFactor
    F6_#m_#m_f = $F6(#m,#m)_f_value * $F6(#m,#m)_f_scaleFactor
    F0_#m_#m_f = U_#m_#m_f + 4 / 195 * F2_#m_#m_f + 2 / 143 * F4_#m_#m_f + 100 / 5577 * F6_#m_#m_f
    U_#f_#m_f  = $U(#f,#m)_f_value
    F2_#f_#m_f = $F2(#f,#m)_f_value * $F2(#f,#m)_f_scaleFactor
    F4_#f_#m_f = $F4(#f,#m)_f_value * $F4(#f,#m)_f_scaleFactor
    G1_#f_#m_f = $G1(#f,#m)_f_value * $G1(#f,#m)_f_scaleFactor
    G3_#f_#m_f = $G3(#f,#m)_f_value * $G3(#f,#m)_f_scaleFactor
    G5_#f_#m_f = $G5(#f,#m)_f_value * $G5(#f,#m)_f_scaleFactor
    F0_#f_#m_f = U_#f_#m_f + 3 / 70 * G1_#f_#m_f + 2 / 105 * G3_#f_#m_f + 5 / 231 * G5_#f_#m_f
