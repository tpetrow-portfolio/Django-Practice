...
if AtomicTerm then
    ...
    F0_3s_4d = NewOperator("U", NFermions, IndexUp_3s, IndexDn_3s, IndexUp_4d, IndexDn_4d, {1}, {0})
    G2_3s_4d = NewOperator("U", NFermions, IndexUp_3s, IndexDn_3s, IndexUp_4d, IndexDn_4d, {0}, {1})
    ...
    U_3s_4d_f = $U(3s,4d)_f_value
    G2_3s_4d_f = $G2(3s,4d)_f_value * $G2(3s,4d)_f_scaleFactor
    F0_3s_4d_f = U_3s_4d_f + 1 / 10 * G2_3s_4d_f
...
if LmctLigandsHybridizationTerm then
    ...
    E_4d_f = (10 * Delta_4d_L1_f - NElectrons_4d * (23 + NElectrons_4d) * U_4d_4d_f / 2 - 22 * U_3s_4d_f) / (12 + NElectrons_4d)
    E_3s_f = (10 * Delta_4d_L1_f + (1 + NElectrons_4d) * (NElectrons_4d * U_4d_4d_f / 2 - (10 + NElectrons_4d) * U_3s_4d_f)) / (12 + NElectrons_4d)
    E_L1_f = (-2 * Delta_4d_L1_f * NElectrons_4d - 4 * Delta_4d_L1_f + U_4d_4d_f * NElectrons_4d^2 + U_4d_4d_f * NElectrons_4d + 4 * U_3s_4d_f * NElectrons_4d + 4 * U_3s_4d_f) / (2 * (NElectrons_4d + 12))
...
if MlctLigandsHybridizationTerm then
    ...
    E_4d_f = -(U_4d_4d_f * NElectrons_4d^2 + 3 * U_4d_4d_f * NElectrons_4d + 4 * U_3s_4d_f) / (2 * NElectrons_4d + 4)
    E_3s_f = NElectrons_4d * (U_4d_4d_f * NElectrons_4d + U_4d_4d_f - 2 * U_3s_4d_f * NElectrons_4d - 2 * U_3s_4d_f) / (2 * (NElectrons_4d + 2))
    E_L2_f = (2 * Delta_4d_L2_f * NElectrons_4d + 4 * Delta_4d_L2_f + U_4d_4d_f * NElectrons_4d^2 - U_4d_4d_f * NElectrons_4d - 4 * U_4d_4d_f + 4 * U_3s_4d_f * NElectrons_4d + 4 * U_3s_4d_f) / (2 * (NElectrons_4d + 2))
...
Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_4d, N_3s, N_4d, "dZ"}
Header = "Analysis of the %s Hamiltonian:\n"
Header = Header .. "=================================================================================================================================\n"
Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3s>    <N_4d>          dZ\n"
Header = Header .. "=================================================================================================================================\n"
Footer = "=================================================================================================================================\n"

if LmctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_4d, N_3s, N_4d, N_L1, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3s>    <N_4d>    <N_L1>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end

if MlctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_4d, N_3s, N_4d, N_L2, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3s>    <N_4d>    <N_L2>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end
...
Txy_3s_4d   = NewOperator("CF", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_3s, IndexDn_3s, {{2, -2, t * I}, {2, 2, -t * I}})
Txz_3s_4d   = NewOperator("CF", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_3s, IndexDn_3s, {{2, -1, t    }, {2, 1, -t    }})
Tyz_3s_4d   = NewOperator("CF", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_3s, IndexDn_3s, {{2, -1, t * I}, {2, 1,  t * I}})
Tx2y2_3s_4d = NewOperator("CF", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_3s, IndexDn_3s, {{2, -2, t    }, {2, 2,  t    }})
Tz2_3s_4d   = NewOperator("CF", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_3s, IndexDn_3s, {{2,  0, 1    }                })
...
local T = {Txy_3s_4d, Txz_3s_4d, Tyz_3s_4d, Tx2y2_3s_4d, Tz2_3s_4d}
Tv_3s_4d = CalculateT(T, Ev, WaveVector)
Th_3s_4d = CalculateT(T, Eh, WaveVector)
Tr_3s_4d = CalculateT(T, Er, WaveVector)
Tl_3s_4d = CalculateT(T, El, WaveVector)
Tk_3s_4d = CalculateT(T, WaveVector, WaveVector)

-- Initialize a table with the available spectra and the required operators.
SpectraAndOperators = {
    ["Isotropic Absorption"] = {Txy_3s_4d, Txz_3s_4d, Tyz_3s_4d, Tx2y2_3s_4d, Tz2_3s_4d},
    ["Absorption"] = {Tk_3s_4d,},
    ["Circular Dichroic"] = {Tr_3s_4d, Tl_3s_4d},
    ["Linear Dichroic"] = {Tv_3s_4d, Th_3s_4d},
}
...
local T = {}
for Operator, _ in pairs(T_3s_4d) do
...
if CalculationRestrictions == nil then
    G_3s_4d = CreateSpectra(H_f, T_3s_4d, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"DenseBorder", DenseBorder}})
else
    G_3s_4d = CreateSpectra(H_f, T_3s_4d, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"Restrictions", CalculationRestrictions}, {"DenseBorder", DenseBorder}})
end

if ShiftSpectra then
    G_3s_4d.Shift(ZeroShift + ExperimentalShift)
end

-- Create a list with the Boltzmann probabilities for a given operator and wavefunction.
local dZ_3s_4d = {}
for _ in ipairs(T_3s_4d) do
    for j in ipairs(Psis_i) do
        table.insert(dZ_3s_4d, dZ_i[j])
    end
end

local Ids = {}
for k, v in pairs(T_3s_4d) do
    Ids[v] = k
end
...
for Spectrum, Operators in pairs(SpectraAndOperators) do
    if ValueInTable(Spectrum, SpectraToCalculate) then
        ...
        if Spectrum == "Isotropic Absorption" then
            Giso = GetSpectrum(G_3s_4d, SpectrumIds, dZ_3s_4d, #T_3s_4d, #Psis_i)
            Giso = Giso / 15
            SaveSpectrum(Giso, Prefix .. "_iso", Gaussian, Lorentzian, Pcl_3s_4d)
        end

        if Spectrum == "Absorption" then
            Gk = GetSpectrum(G_3s_4d, SpectrumIds, dZ_3s_4d, #T_3s_4d, #Psis_i)
            SaveSpectrum(Gk, Prefix .. "_k", Gaussian, Lorentzian, Pcl_3s_4d)
        end

        if Spectrum == "Circular Dichroic" then
            Gr = GetSpectrum(G_3s_4d, SpectrumIds[1], dZ_3s_4d, #T_3s_4d, #Psis_i)
            Gl = GetSpectrum(G_3s_4d, SpectrumIds[2], dZ_3s_4d, #T_3s_4d, #Psis_i)
            SaveSpectrum(Gr, Prefix .. "_r", Gaussian, Lorentzian, Pcl_3s_4d)
            SaveSpectrum(Gl, Prefix .. "_l", Gaussian, Lorentzian, Pcl_3s_4d)
            SaveSpectrum(Gr - Gl, Prefix .. "_cd", Gaussian, Lorentzian)
        end

        if Spectrum == "Linear Dichroic" then
            Gv = GetSpectrum(G_3s_4d, SpectrumIds[1], dZ_3s_4d, #T_3s_4d, #Psis_i)
            Gh = GetSpectrum(G_3s_4d, SpectrumIds[2], dZ_3s_4d, #T_3s_4d, #Psis_i)
            SaveSpectrum(Gv, Prefix .. "_v", Gaussian, Lorentzian, Pcl_3s_4d)
            SaveSpectrum(Gh, Prefix .. "_h", Gaussian, Lorentzian, Pcl_3s_4d)
