...
if LmctLigandsHybridizationTerm then
    ...
    E_L1_f = (-2 * Delta_5d_L1_f * NElectrons_5d - 4 * Delta_5d_L1_f + U_5d_5d_f * NElectrons_5d^2 + U_5d_5d_f * NElectrons_5d + 4 * U_4s_5d_f * NElectrons_5d + 4 * U_4s_5d_f) / (2 * (NElectrons_5d + 12))
...
if MlctLigandsHybridizationTerm then
    ...
    E_L2_f = (2 * Delta_5d_L2_f * NElectrons_5d + 4 * Delta_5d_L2_f + U_5d_5d_f * NElectrons_5d^2 - U_5d_5d_f * NElectrons_5d - 4 * U_5d_5d_f + 4 * U_4s_5d_f * NElectrons_5d + 4 * U_4s_5d_f) / (2 * (NElectrons_5d + 2))
...
for i = 1, NElectrons_4s / 2 do
    T_4s_5d[2*i - 1] = NewOperator("An", NFermions, IndexDn_4s[i])
    T_4s_5d[2*i]     = NewOperator("An", NFermions, IndexUp_4s[i])
end
...
if ValueInTable(Spectrum, SpectraToCalculate) then
    SpectrumIds = {}
    c = 1
    for i, Operator in ipairs(T_4s_5d) do
