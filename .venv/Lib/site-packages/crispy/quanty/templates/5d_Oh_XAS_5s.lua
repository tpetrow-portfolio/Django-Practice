...
if AtomicTerm then
    ...
    G2_5s_5d_f = $G2(5s,5d)_f_value * $G2(5s,5d)_f_scaleFactor
...
if LmctLigandsHybridizationTerm then
    ...
    E_L1_f = (-2 * Delta_5d_L1_f * NElectrons_5d - 4 * Delta_5d_L1_f + U_5d_5d_f * NElectrons_5d^2 + U_5d_5d_f * NElectrons_5d + 4 * U_5s_5d_f * NElectrons_5d + 4 * U_5s_5d_f) / (2 * (NElectrons_5d + 12))
...
if MlctLigandsHybridizationTerm then
    ...
    E_L2_f = (2 * Delta_5d_L2_f * NElectrons_5d + 4 * Delta_5d_L2_f + U_5d_5d_f * NElectrons_5d^2 - U_5d_5d_f * NElectrons_5d - 4 * U_5d_5d_f + 4 * U_5s_5d_f * NElectrons_5d + 4 * U_5s_5d_f) / (2 * (NElectrons_5d + 2))
...
if MlctLigandsHybridizationTerm then
    ...
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_5s>    <N_5d>    <N_L2>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end
...
Txy_5s_5d   = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5s, IndexDn_5s, {{2, -2, t * I}, {2, 2, -t * I}})
Txz_5s_5d   = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5s, IndexDn_5s, {{2, -1, t    }, {2, 1, -t    }})
Tyz_5s_5d   = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5s, IndexDn_5s, {{2, -1, t * I}, {2, 1,  t * I}})
Tx2y2_5s_5d = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5s, IndexDn_5s, {{2, -2, t    }, {2, 2,  t    }})
Tz2_5s_5d   = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5s, IndexDn_5s, {{2,  0, 1    }                })
...
local T = {Txy_5s_5d, Txz_5s_5d, Tyz_5s_5d, Tx2y2_5s_5d, Tz2_5s_5d}
Tv_5s_5d = CalculateT(T, Ev, WaveVector)
Th_5s_5d = CalculateT(T, Eh, WaveVector)
Tr_5s_5d = CalculateT(T, Er, WaveVector)
Tl_5s_5d = CalculateT(T, El, WaveVector)
...
local T = {}
for Operator, _ in pairs(T_5s_5d) do
...
if CalculationRestrictions == nil then
    ...
    G_5s_5d = CreateSpectra(H_f, T_5s_5d, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"Restrictions", CalculationRestrictions}, {"DenseBorder", DenseBorder}})
end

if ShiftSpectra then
    G_5s_5d.Shift(ZeroShift + ExperimentalShift)
end

-- Create a list with the Boltzmann probabilities for a given operator and wavefunction.
local dZ_5s_5d = {}
for _ in ipairs(T_5s_5d) do
    for j in ipairs(Psis_i) do
        table.insert(dZ_5s_5d, dZ_i[j])
    end
end

local Ids = {}
for k, v in pairs(T_5s_5d) do
    Ids[v] = k
end
...
for Spectrum, Operators in pairs(SpectraAndOperators) do
    if ValueInTable(Spectrum, SpectraToCalculate) then
        ...
        if Spectrum == "Isotropic Absorption" then
            Giso = GetSpectrum(G_5s_5d, SpectrumIds, dZ_5s_5d, #T_5s_5d, #Psis_i)
            Giso = Giso / 15
            SaveSpectrum(Giso, Prefix .. "_iso", Gaussian, Lorentzian, Pcl_5s_5d)
        end
        ...
        if Spectrum == "Circular Dichroic" then
            Gr = GetSpectrum(G_5s_5d, SpectrumIds[1], dZ_5s_5d, #T_5s_5d, #Psis_i)
            Gl = GetSpectrum(G_5s_5d, SpectrumIds[2], dZ_5s_5d, #T_5s_5d, #Psis_i)
            SaveSpectrum(Gr, Prefix .. "_r", Gaussian, Lorentzian, Pcl_5s_5d)
            SaveSpectrum(Gl, Prefix .. "_l", Gaussian, Lorentzian, Pcl_5s_5d)
            SaveSpectrum(Gr - Gl, Prefix .. "_cd", Gaussian, Lorentzian)
        end

        if Spectrum == "Linear Dichroic" then
            Gv = GetSpectrum(G_5s_5d, SpectrumIds[1], dZ_5s_5d, #T_5s_5d, #Psis_i)
            Gh = GetSpectrum(G_5s_5d, SpectrumIds[2], dZ_5s_5d, #T_5s_5d, #Psis_i)
            SaveSpectrum(Gv, Prefix .. "_v", Gaussian, Lorentzian, Pcl_5s_5d)
            SaveSpectrum(Gh, Prefix .. "_h", Gaussian, Lorentzian, Pcl_5s_5d)
