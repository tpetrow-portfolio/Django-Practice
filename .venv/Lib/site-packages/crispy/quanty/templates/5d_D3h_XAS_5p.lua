...
Tx_5p_5d = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5p, IndexDn_5p, {{1, -1, t}, {1, 1, -t}})
Ty_5p_5d = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5p, IndexDn_5p, {{1, -1, t * I}, {1, 1, t * I}})
Tz_5p_5d = NewOperator("CF", NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5p, IndexDn_5p, {{1, 0, 1}})
...
local T = {Tx_5p_5d, Ty_5p_5d, Tz_5p_5d}
Tv_5p_5d = CalculateT(T, Ev)
Th_5p_5d = CalculateT(T, Eh)
Tr_5p_5d = CalculateT(T, Er)
Tl_5p_5d = CalculateT(T, El)
Tk_5p_5d = CalculateT(T, WaveVector)

-- Initialize a table with the available spectra and the required operators.
SpectraAndOperators = {
    ["Isotropic Absorption"] = {Tk_5p_5d, Tr_5p_5d, Tl_5p_5d},
    ["Absorption"] = {Tk_5p_5d,},
    ["Circular Dichroic"] = {Tr_5p_5d, Tl_5p_5d},
    ["Linear Dichroic"] = {Tv_5p_5d, Th_5p_5d},
}
...
local T = {}
for Operator, _ in pairs(T_5p_5d) do
...
for Spectrum, Operators in pairs(SpectraAndOperators) do
    if ValueInTable(Spectrum, SpectraToCalculate) then
        ...
        if Spectrum == "Isotropic Absorption" then
            ...
            Giso = Giso / 3
            SaveSpectrum(Giso, Prefix .. "_iso", Gaussian, Lorentzian, Pcl_5p_5d)
        end

        if Spectrum == "Absorption" then
            Gk = GetSpectrum(G_5p_5d, SpectrumIds, dZ_5p_5d, #T_5p_5d, #Psis_i)
            SaveSpectrum(Gk, Prefix .. "_k", Gaussian, Lorentzian, Pcl_5p_5d)
        end

        if Spectrum == "Circular Dichroic" then
            Gr = GetSpectrum(G_5p_5d, SpectrumIds[1], dZ_5p_5d, #T_5p_5d, #Psis_i)
            Gl = GetSpectrum(G_5p_5d, SpectrumIds[2], dZ_5p_5d, #T_5p_5d, #Psis_i)
            SaveSpectrum(Gr, Prefix .. "_r", Gaussian, Lorentzian, Pcl_5p_5d)
            SaveSpectrum(Gl, Prefix .. "_l", Gaussian, Lorentzian, Pcl_5p_5d)
            SaveSpectrum(Gr - Gl, Prefix .. "_cd", Gaussian, Lorentzian)
        end

        if Spectrum == "Linear Dichroic" then
            Gv = GetSpectrum(G_5p_5d, SpectrumIds[1], dZ_5p_5d, #T_5p_5d, #Psis_i)
            Gh = GetSpectrum(G_5p_5d, SpectrumIds[2], dZ_5p_5d, #T_5p_5d, #Psis_i)
            SaveSpectrum(Gv, Prefix .. "_v", Gaussian, Lorentzian, Pcl_5p_5d)
            SaveSpectrum(Gh, Prefix .. "_h", Gaussian, Lorentzian, Pcl_5p_5d)
