...
if LmctLigandsHybridizationTerm then
    ...
    E_L1_f = (-2 * Delta_4d_L1_f * NElectrons_4d - 4 * Delta_4d_L1_f + U_4d_4d_f * NElectrons_4d^2 + U_4d_4d_f * NElectrons_4d + 4 * U_2s_4d_f * NElectrons_4d + 4 * U_2s_4d_f) / (2 * (NElectrons_4d + 12))
...
if MlctLigandsHybridizationTerm then
    ...
    E_L2_f = (2 * Delta_4d_L2_f * NElectrons_4d + 4 * Delta_4d_L2_f + U_4d_4d_f * NElectrons_4d^2 - U_4d_4d_f * NElectrons_4d - 4 * U_4d_4d_f + 4 * U_2s_4d_f * NElectrons_4d + 4 * U_2s_4d_f) / (2 * (NElectrons_4d + 2))
...
if MlctLigandsHybridizationTerm then
    ...
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_2s>    <N_4d>    <N_L2>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end
...
for i = 1, NElectrons_2s / 2 do
    T_2s_4d[2*i - 1] = NewOperator("An", NFermions, IndexDn_2s[i])
    T_2s_4d[2*i]     = NewOperator("An", NFermions, IndexUp_2s[i])
end
...
if ValueInTable(Spectrum, SpectraToCalculate) then
    SpectrumIds = {}
    c = 1
    for i, Operator in ipairs(T_2s_4d) do
