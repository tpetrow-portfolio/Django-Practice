...
local T = {Tx_3p_4d, Ty_3p_4d, Tz_3p_4d}
Tv_3p_4d = CalculateT(T, Ev)
Th_3p_4d = CalculateT(T, Eh)
Tr_3p_4d = CalculateT(T, Er)
Tl_3p_4d = CalculateT(T, El)
Tk_3p_4d = CalculateT(T, WaveVector)
...
for Spectrum, Operators in pairs(SpectraAndOperators) do
    if ValueInTable(Spectrum, SpectraToCalculate) then
        ...
        if Spectrum == "Isotropic Absorption" then
            ...
            Giso = Giso / 3
            SaveSpectrum(Giso, Prefix .. "_iso", Gaussian, Lorentzian, Pcl_3p_4d)
        end

        if Spectrum == "Absorption" then
            Gk = GetSpectrum(G_3p_4d, SpectrumIds, dZ_3p_4d, #T_3p_4d, #Psis_i)
            SaveSpectrum(Gk, Prefix .. "_k", Gaussian, Lorentzian, Pcl_3p_4d)
        end
        ...
        if Spectrum == "Circular Dichroic" then
            ...
            SaveSpectrum(Gr, Prefix .. "_r", Gaussian, Lorentzian, Pcl_3p_4d)
            SaveSpectrum(Gl, Prefix .. "_l", Gaussian, Lorentzian, Pcl_3p_4d)
        ...
        if Spectrum == "Linear Dichroic" then
            ...
            SaveSpectrum(Gv, Prefix .. "_v", Gaussian, Lorentzian, Pcl_3p_4d)
            SaveSpectrum(Gh, Prefix .. "_h", Gaussian, Lorentzian, Pcl_3p_4d)
