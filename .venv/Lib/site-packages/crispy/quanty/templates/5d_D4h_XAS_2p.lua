...
if LmctLigandsHybridizationTerm then
    ...
    E_5d_f = (10 * Delta_5d_L1_f - NElectrons_5d * (31 + NElectrons_5d) * U_5d_5d_f / 2 - 90 * U_2p_5d_f) / (16 + NElectrons_5d)
    E_2p_f = (10 * Delta_5d_L1_f + (1 + NElectrons_5d) * (NElectrons_5d * U_5d_5d_f / 2 - (10 + NElectrons_5d) * U_2p_5d_f)) / (16 + NElectrons_5d)
    E_L1_f = ((1 + NElectrons_5d) * (NElectrons_5d * U_5d_5d_f / 2 + 6 * U_2p_5d_f) - (6 + NElectrons_5d) * Delta_5d_L1_f) / (16 + NElectrons_5d)
...
local T = {Tx_2p_5d, Ty_2p_5d, Tz_2p_5d}
Tv_2p_5d = CalculateT(T, Ev)
Th_2p_5d = CalculateT(T, Eh)
Tr_2p_5d = CalculateT(T, Er)
Tl_2p_5d = CalculateT(T, El)
Tk_2p_5d = CalculateT(T, WaveVector)
