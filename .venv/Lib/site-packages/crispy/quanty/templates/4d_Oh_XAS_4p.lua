...
if MlctLigandsHybridizationTerm then
    ...
    E_L2_f = (2 * Delta_4d_L2_f * NElectrons_4d + 12 * Delta_4d_L2_f + U_4d_4d_f * NElectrons_4d^2 - U_4d_4d_f * NElectrons_4d - 12 * U_4d_4d_f + 12 * U_4p_4d_f * NElectrons_4d + 12 * U_4p_4d_f) / (2 * (NElectrons_4d + 6))
...
if MlctLigandsHybridizationTerm then
    ...
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_4p>    <N_4d>    <N_L2>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end
...
local T = {Tx_4p_4d, Ty_4p_4d, Tz_4p_4d}
Tv_4p_4d = CalculateT(T, Ev)
Th_4p_4d = CalculateT(T, Eh)
Tr_4p_4d = CalculateT(T, Er)
Tl_4p_4d = CalculateT(T, El)
Tk_4p_4d = CalculateT(T, WaveVector)

-- Initialize a table with the available spectra and the required operators.
SpectraAndOperators = {
    ["Isotropic Absorption"] = {Tk_4p_4d, Tr_4p_4d, Tl_4p_4d},
    ["Absorption"] = {Tk_4p_4d,},
    ["Circular Dichroic"] = {Tr_4p_4d, Tl_4p_4d},
    ["Linear Dichroic"] = {Tv_4p_4d, Th_4p_4d},
}
...
local T = {}
for Operator, _ in pairs(T_4p_4d) do
...
for Spectrum, Operators in pairs(SpectraAndOperators) do
    if ValueInTable(Spectrum, SpectraToCalculate) then
        ...
        if Spectrum == "Isotropic Absorption" then
            ...
            Giso = Giso / 3
            SaveSpectrum(Giso, Prefix .. "_iso", Gaussian, Lorentzian, Pcl_4p_4d)
        end

        if Spectrum == "Absorption" then
            Gk = GetSpectrum(G_4p_4d, SpectrumIds, dZ_4p_4d, #T_4p_4d, #Psis_i)
            SaveSpectrum(Gk, Prefix .. "_k", Gaussian, Lorentzian, Pcl_4p_4d)
        end

        if Spectrum == "Circular Dichroic" then
            Gr = GetSpectrum(G_4p_4d, SpectrumIds[1], dZ_4p_4d, #T_4p_4d, #Psis_i)
            Gl = GetSpectrum(G_4p_4d, SpectrumIds[2], dZ_4p_4d, #T_4p_4d, #Psis_i)
            SaveSpectrum(Gr, Prefix .. "_r", Gaussian, Lorentzian, Pcl_4p_4d)
            SaveSpectrum(Gl, Prefix .. "_l", Gaussian, Lorentzian, Pcl_4p_4d)
            SaveSpectrum(Gr - Gl, Prefix .. "_cd", Gaussian, Lorentzian)
        end

        if Spectrum == "Linear Dichroic" then
            Gv = GetSpectrum(G_4p_4d, SpectrumIds[1], dZ_4p_4d, #T_4p_4d, #Psis_i)
            Gh = GetSpectrum(G_4p_4d, SpectrumIds[2], dZ_4p_4d, #T_4p_4d, #Psis_i)
            SaveSpectrum(Gv, Prefix .. "_v", Gaussian, Lorentzian, Pcl_4p_4d)
            SaveSpectrum(Gh, Prefix .. "_h", Gaussian, Lorentzian, Pcl_4p_4d)
