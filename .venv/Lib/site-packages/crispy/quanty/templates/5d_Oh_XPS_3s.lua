...
if LmctLigandsHybridizationTerm then
    ...
    E_L1_f = (-2 * Delta_5d_L1_f * NElectrons_5d - 4 * Delta_5d_L1_f + U_5d_5d_f * NElectrons_5d^2 + U_5d_5d_f * NElectrons_5d + 4 * U_3s_5d_f * NElectrons_5d + 4 * U_3s_5d_f) / (2 * (NElectrons_5d + 12))
...
if MlctLigandsHybridizationTerm then
    ...
    E_L2_f = (2 * Delta_5d_L2_f * NElectrons_5d + 4 * Delta_5d_L2_f + U_5d_5d_f * NElectrons_5d^2 - U_5d_5d_f * NElectrons_5d - 4 * U_5d_5d_f + 4 * U_3s_5d_f * NElectrons_5d + 4 * U_3s_5d_f) / (2 * (NElectrons_5d + 2))
...
if MlctLigandsHybridizationTerm then
    ...
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3s>    <N_5d>    <N_L2>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end
