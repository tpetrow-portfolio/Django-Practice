...
if AtomicTerm then
    ...
    U_3d_3d_i = 0.0
    F2_3d_3d_i = 12.2338 * 0.75
    F4_3d_3d_i = 7.5975 * 0.75
    F0_3d_3d_i = U_3d_3d_i + 2 / 63 * F2_3d_3d_i + 2 / 63 * F4_3d_3d_i

    U_3d_3d_f = 0.0
    F2_3d_3d_f = 13.0058 * 0.75
    F4_3d_3d_f = 8.0839 * 0.75
    F0_3d_3d_f = U_3d_3d_f + 2 / 63 * F2_3d_3d_f + 2 / 63 * F4_3d_3d_f
    U_2p_3d_f = 0.0
    F2_2p_3d_f = 7.7213 * 0.75
    G1_2p_3d_f = 5.7865 * 0.7
    G3_2p_3d_f = 3.2909 * 0.7
    ...
    zeta_3d_i = 0.0826 * 0.9

    zeta_3d_f = 0.1022 * 0.9
    zeta_2p_f = 11.507 * 0.9
