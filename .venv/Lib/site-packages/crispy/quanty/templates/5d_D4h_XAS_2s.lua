...
if AtomicTerm then
    ...
    G2_2s_5d_f = $G2(2s,5d)_f_value * $G2(2s,5d)_f_scaleFactor
    F0_2s_5d_f = U_2s_5d_f + 1 / 10 * G2_2s_5d_f
...
if LmctLigandsHybridizationTerm then
    ...
    E_5d_f = (10 * Delta_5d_L1_f - NElectrons_5d * (23 + NElectrons_5d) * U_5d_5d_f / 2 - 22 * U_2s_5d_f) / (12 + NElectrons_5d)
    E_2s_f = (10 * Delta_5d_L1_f + (1 + NElectrons_5d) * (NElectrons_5d * U_5d_5d_f / 2 - (10 + NElectrons_5d) * U_2s_5d_f)) / (12 + NElectrons_5d)
    E_L1_f = (-2 * Delta_5d_L1_f * NElectrons_5d - 4 * Delta_5d_L1_f + U_5d_5d_f * NElectrons_5d^2 + U_5d_5d_f * NElectrons_5d + 4 * U_2s_5d_f * NElectrons_5d + 4 * U_2s_5d_f) / (2 * (NElectrons_5d + 12))
...
if MlctLigandsHybridizationTerm then
    ...
    E_5d_f = -(U_5d_5d_f * NElectrons_5d^2 + 3 * U_5d_5d_f * NElectrons_5d + 4 * U_2s_5d_f) / (2 * NElectrons_5d + 4)
    E_2s_f = NElectrons_5d * (U_5d_5d_f * NElectrons_5d + U_5d_5d_f - 2 * U_2s_5d_f * NElectrons_5d - 2 * U_2s_5d_f) / (2 * (NElectrons_5d + 2))
    E_L2_f = (2 * Delta_5d_L2_f * NElectrons_5d + 4 * Delta_5d_L2_f + U_5d_5d_f * NElectrons_5d^2 - U_5d_5d_f * NElectrons_5d - 4 * U_5d_5d_f + 4 * U_2s_5d_f * NElectrons_5d + 4 * U_2s_5d_f) / (2 * (NElectrons_5d + 2))
...
Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5d, N_2s, N_5d, "dZ"}
Header = "Analysis of the %s Hamiltonian:\n"
Header = Header .. "=================================================================================================================================\n"
Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_2s>    <N_5d>          dZ\n"
Header = Header .. "=================================================================================================================================\n"
Footer = "=================================================================================================================================\n"

if LmctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5d, N_2s, N_5d, N_L1, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_2s>    <N_5d>    <N_L1>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end

if MlctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5d, N_2s, N_5d, N_L2, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_2s>    <N_5d>    <N_L2>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end
...
local T = {Txy_2s_5d, Txz_2s_5d, Tyz_2s_5d, Tx2y2_2s_5d, Tz2_2s_5d}
Tv_2s_5d = CalculateT(T, Ev, WaveVector)
Th_2s_5d = CalculateT(T, Eh, WaveVector)
Tr_2s_5d = CalculateT(T, Er, WaveVector)
Tl_2s_5d = CalculateT(T, El, WaveVector)
...
local T = {}
for Operator, _ in pairs(T_2s_5d) do
...
if CalculationRestrictions == nil then
    G_2s_5d = CreateSpectra(H_f, T_2s_5d, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"DenseBorder", DenseBorder}})
else
    G_2s_5d = CreateSpectra(H_f, T_2s_5d, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"Restrictions", CalculationRestrictions}, {"DenseBorder", DenseBorder}})
end

if ShiftSpectra then
    G_2s_5d.Shift(ZeroShift + ExperimentalShift)
end

-- Create a list with the Boltzmann probabilities for a given operator and wavefunction.
local dZ_2s_5d = {}
for _ in ipairs(T_2s_5d) do
    for j in ipairs(Psis_i) do
        table.insert(dZ_2s_5d, dZ_i[j])
    end
end

local Ids = {}
for k, v in pairs(T_2s_5d) do
    Ids[v] = k
end
...
for Spectrum, Operators in pairs(SpectraAndOperators) do
    if ValueInTable(Spectrum, SpectraToCalculate) then
        ...
        if Spectrum == "Isotropic Absorption" then
            Giso = GetSpectrum(G_2s_5d, SpectrumIds, dZ_2s_5d, #T_2s_5d, #Psis_i)
            Giso = Giso / 15
            SaveSpectrum(Giso, Prefix .. "_iso", Gaussian, Lorentzian, Pcl_2s_5d)
        end
        ...
        if Spectrum == "Circular Dichroic" then
            Gr = GetSpectrum(G_2s_5d, SpectrumIds[1], dZ_2s_5d, #T_2s_5d, #Psis_i)
            Gl = GetSpectrum(G_2s_5d, SpectrumIds[2], dZ_2s_5d, #T_2s_5d, #Psis_i)
            SaveSpectrum(Gr, Prefix .. "_r", Gaussian, Lorentzian, Pcl_2s_5d)
            SaveSpectrum(Gl, Prefix .. "_l", Gaussian, Lorentzian, Pcl_2s_5d)
            SaveSpectrum(Gr - Gl, Prefix .. "_cd", Gaussian, Lorentzian)
        end

        if Spectrum == "Linear Dichroic" then
            Gv = GetSpectrum(G_2s_5d, SpectrumIds[1], dZ_2s_5d, #T_2s_5d, #Psis_i)
            Gh = GetSpectrum(G_2s_5d, SpectrumIds[2], dZ_2s_5d, #T_2s_5d, #Psis_i)
            SaveSpectrum(Gv, Prefix .. "_v", Gaussian, Lorentzian, Pcl_2s_5d)
            SaveSpectrum(Gh, Prefix .. "_h", Gaussian, Lorentzian, Pcl_2s_5d)
