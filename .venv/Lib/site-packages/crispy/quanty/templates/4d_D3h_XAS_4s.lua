...
Txy_4s_4d   = NewOperator("CF", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_4s, IndexDn_4s, {{2, -2, t * I}, {2, 2, -t * I}})
Txz_4s_4d   = NewOperator("CF", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_4s, IndexDn_4s, {{2, -1, t    }, {2, 1, -t    }})
Tyz_4s_4d   = NewOperator("CF", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_4s, IndexDn_4s, {{2, -1, t * I}, {2, 1,  t * I}})
Tx2y2_4s_4d = NewOperator("CF", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_4s, IndexDn_4s, {{2, -2, t    }, {2, 2,  t    }})
Tz2_4s_4d   = NewOperator("CF", NFermions, IndexUp_4d, IndexDn_4d, IndexUp_4s, IndexDn_4s, {{2,  0, 1    }                })
...
local T = {Txy_4s_4d, Txz_4s_4d, Tyz_4s_4d, Tx2y2_4s_4d, Tz2_4s_4d}
Tv_4s_4d = CalculateT(T, Ev, WaveVector)
Th_4s_4d = CalculateT(T, Eh, WaveVector)
Tr_4s_4d = CalculateT(T, Er, WaveVector)
Tl_4s_4d = CalculateT(T, El, WaveVector)
Tk_4s_4d = CalculateT(T, WaveVector, WaveVector)

-- Initialize a table with the available spectra and the required operators.
SpectraAndOperators = {
    ["Isotropic Absorption"] = {Txy_4s_4d, Txz_4s_4d, Tyz_4s_4d, Tx2y2_4s_4d, Tz2_4s_4d},
    ["Absorption"] = {Tk_4s_4d,},
    ["Circular Dichroic"] = {Tr_4s_4d, Tl_4s_4d},
    ["Linear Dichroic"] = {Tv_4s_4d, Th_4s_4d},
}
...
local T = {}
for Operator, _ in pairs(T_4s_4d) do
...
for Spectrum, Operators in pairs(SpectraAndOperators) do
    if ValueInTable(Spectrum, SpectraToCalculate) then
        ...
        if Spectrum == "Absorption" then
            Gk = GetSpectrum(G_4s_4d, SpectrumIds, dZ_4s_4d, #T_4s_4d, #Psis_i)
            SaveSpectrum(Gk, Prefix .. "_k", Gaussian, Lorentzian, Pcl_4s_4d)
        end

        if Spectrum == "Circular Dichroic" then
            Gr = GetSpectrum(G_4s_4d, SpectrumIds[1], dZ_4s_4d, #T_4s_4d, #Psis_i)
            Gl = GetSpectrum(G_4s_4d, SpectrumIds[2], dZ_4s_4d, #T_4s_4d, #Psis_i)
            SaveSpectrum(Gr, Prefix .. "_r", Gaussian, Lorentzian, Pcl_4s_4d)
            SaveSpectrum(Gl, Prefix .. "_l", Gaussian, Lorentzian, Pcl_4s_4d)
            SaveSpectrum(Gr - Gl, Prefix .. "_cd", Gaussian, Lorentzian)
        end

        if Spectrum == "Linear Dichroic" then
            Gv = GetSpectrum(G_4s_4d, SpectrumIds[1], dZ_4s_4d, #T_4s_4d, #Psis_i)
            Gh = GetSpectrum(G_4s_4d, SpectrumIds[2], dZ_4s_4d, #T_4s_4d, #Psis_i)
            SaveSpectrum(Gv, Prefix .. "_v", Gaussian, Lorentzian, Pcl_4s_4d)
            SaveSpectrum(Gh, Prefix .. "_h", Gaussian, Lorentzian, Pcl_4s_4d)
