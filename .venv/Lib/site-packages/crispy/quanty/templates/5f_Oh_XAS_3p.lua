...
if AtomicTerm then
    ...
    F0_3p_5f = NewOperator("U", NFermions, IndexUp_3p, IndexDn_3p, IndexUp_5f, IndexDn_5f, {1, 0}, {0, 0})
    F2_3p_5f = NewOperator("U", NFermions, IndexUp_3p, IndexDn_3p, IndexUp_5f, IndexDn_5f, {0, 1}, {0, 0})
    G2_3p_5f = NewOperator("U", NFermions, IndexUp_3p, IndexDn_3p, IndexUp_5f, IndexDn_5f, {0, 0}, {1, 0})
    G4_3p_5f = NewOperator("U", NFermions, IndexUp_3p, IndexDn_3p, IndexUp_5f, IndexDn_5f, {0, 0}, {0, 1})
    ...
    U_3p_5f_f = $U(3p,5f)_f_value
    F2_3p_5f_f = $F2(3p,5f)_f_value * $F2(3p,5f)_f_scaleFactor
    G2_3p_5f_f = $G2(3p,5f)_f_value * $G2(3p,5f)_f_scaleFactor
    G4_3p_5f_f = $G4(3p,5f)_f_value * $G4(3p,5f)_f_scaleFactor
    F0_3p_5f_f = U_3p_5f_f + 3 / 70 * G2_3p_5f_f + 2 / 63 * G4_3p_5f_f
...
if LmctLigandsHybridizationTerm then
    ...
    E_5f_f = (28 * Delta_5f_L1_f - U_5f_5f_f * NElectrons_5f^2 - 39 * U_5f_5f_f * NElectrons_5f - 228 * U_3p_5f_f) / (2 * (NElectrons_5f + 20))
    E_3p_f = (28 * Delta_5f_L1_f + U_5f_5f_f * NElectrons_5f^2 + U_5f_5f_f * NElectrons_5f - 2 * U_3p_5f_f * NElectrons_5f^2 - 30 * U_3p_5f_f * NElectrons_5f - 28 * U_3p_5f_f) / (2 * (NElectrons_5f + 20))
    E_L1_f = (-2 * Delta_5f_L1_f * NElectrons_5f - 12 * Delta_5f_L1_f + U_5f_5f_f * NElectrons_5f^2 + U_5f_5f_f * NElectrons_5f + 12 * U_3p_5f_f * NElectrons_5f + 12 * U_3p_5f_f) / (2 * (NElectrons_5f + 20))
...
Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5f, N_3p, N_5f, "dZ"}
Header = "Analysis of the %s Hamiltonian:\n"
Header = Header .. "=================================================================================================================================\n"
Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3p>    <N_5f>          dZ\n"
Header = Header .. "=================================================================================================================================\n"
Footer = "=================================================================================================================================\n"

if LmctLigandsHybridizationTerm then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sk, Lk, Jk, Tk, ldots_5f, N_3p, N_5f, N_L1, "dZ"}
    Header = "Analysis of the %s Hamiltonian:\n"
    Header = Header .. "===========================================================================================================================================\n"
    Header = Header .. "State           E     <S^2>     <L^2>     <J^2>      <Sk>      <Lk>      <Jk>      <Tk>     <l.s>    <N_3p>    <N_5f>    <N_L1>          dZ\n"
    Header = Header .. "===========================================================================================================================================\n"
    Footer = "===========================================================================================================================================\n"
end
...
Txy_3p_5f   = NewOperator("CF", NFermions, IndexUp_5f, IndexDn_5f, IndexUp_3p, IndexDn_3p, {{2, -2, t * I}, {2, 2, -t * I}})
Txz_3p_5f   = NewOperator("CF", NFermions, IndexUp_5f, IndexDn_5f, IndexUp_3p, IndexDn_3p, {{2, -1, t    }, {2, 1, -t    }})
Tyz_3p_5f   = NewOperator("CF", NFermions, IndexUp_5f, IndexDn_5f, IndexUp_3p, IndexDn_3p, {{2, -1, t * I}, {2, 1,  t * I}})
Tx2y2_3p_5f = NewOperator("CF", NFermions, IndexUp_5f, IndexDn_5f, IndexUp_3p, IndexDn_3p, {{2, -2, t    }, {2, 2,  t    }})
Tz2_3p_5f   = NewOperator("CF", NFermions, IndexUp_5f, IndexDn_5f, IndexUp_3p, IndexDn_3p, {{2,  0, 1    }                })
...
local T = {Txy_3p_5f, Txz_3p_5f, Tyz_3p_5f, Tx2y2_3p_5f, Tz2_3p_5f}
Tv_3p_5f = CalculateT(T, Ev, WaveVector)
Th_3p_5f = CalculateT(T, Eh, WaveVector)
Tr_3p_5f = CalculateT(T, Er, WaveVector)
Tl_3p_5f = CalculateT(T, El, WaveVector)
...
local T = {}
for Operator, _ in pairs(T_3p_5f) do
...
if CalculationRestrictions == nil then
    G_3p_5f = CreateSpectra(H_f, T_3p_5f, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"DenseBorder", DenseBorder}})
else
    G_3p_5f = CreateSpectra(H_f, T_3p_5f, Psis_i, {{"Emin", Emin}, {"Emax", Emax}, {"NE", NPoints}, {"Gamma", Gamma}, {"Restrictions", CalculationRestrictions}, {"DenseBorder", DenseBorder}})
end

if ShiftSpectra then
    G_3p_5f.Shift(ZeroShift + ExperimentalShift)
end

-- Create a list with the Boltzmann probabilities for a given operator and wavefunction.
local dZ_3p_5f = {}
for _ in ipairs(T_3p_5f) do
    for j in ipairs(Psis_i) do
        table.insert(dZ_3p_5f, dZ_i[j])
    end
end

local Ids = {}
for k, v in pairs(T_3p_5f) do
    Ids[v] = k
end
...
for Spectrum, Operators in pairs(SpectraAndOperators) do
    if ValueInTable(Spectrum, SpectraToCalculate) then
        ...
        if Spectrum == "Isotropic Absorption" then
            Giso = GetSpectrum(G_3p_5f, SpectrumIds, dZ_3p_5f, #T_3p_5f, #Psis_i)
            Giso = Giso / 15
            SaveSpectrum(Giso, Prefix .. "_iso", Gaussian, Lorentzian, Pcl_3p_5f)
        end
        ...
        if Spectrum == "Circular Dichroic" then
            Gr = GetSpectrum(G_3p_5f, SpectrumIds[1], dZ_3p_5f, #T_3p_5f, #Psis_i)
            Gl = GetSpectrum(G_3p_5f, SpectrumIds[2], dZ_3p_5f, #T_3p_5f, #Psis_i)
            SaveSpectrum(Gr, Prefix .. "_r", Gaussian, Lorentzian, Pcl_3p_5f)
            SaveSpectrum(Gl, Prefix .. "_l", Gaussian, Lorentzian, Pcl_3p_5f)
            SaveSpectrum(Gr - Gl, Prefix .. "_cd", Gaussian, Lorentzian)
        end

        if Spectrum == "Linear Dichroic" then
            Gv = GetSpectrum(G_3p_5f, SpectrumIds[1], dZ_3p_5f, #T_3p_5f, #Psis_i)
            Gh = GetSpectrum(G_3p_5f, SpectrumIds[2], dZ_3p_5f, #T_3p_5f, #Psis_i)
            SaveSpectrum(Gv, Prefix .. "_v", Gaussian, Lorentzian, Pcl_3p_5f)
            SaveSpectrum(Gh, Prefix .. "_h", Gaussian, Lorentzian, Pcl_3p_5f)
